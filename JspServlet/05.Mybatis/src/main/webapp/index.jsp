	...
	<header>
		<div class="inner">
			...
			<ul id="gnb">
				...
				<li><a href="#">사원목록</a></li>
				<li><a href="#">고객관리</a></li>
				<li><a href="list.lyj">내이니셜</a></li>
				<!-- list.lyj를 요청하면 요청 받을 수 있는 Controller를 추가한다.
					 list.lyj가 아닌 ab등을 요청하면 콘솔창에 잘못된 요청이라는 글자 찍힘.
					 list.lyj가 요청되면 field를 두개 가진 DTO ArrayList로 만들고 list.lyj에서는
					 (lyj/list.jsp 실행)
					 el과 jstl을 사용해서 보여준다.
				 -->
				<li><a href="asdf.bat">mybatis</a></li>
			</ul>
